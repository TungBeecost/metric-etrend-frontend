  ...
  <div id="search_report">
    ...
    <div class="container default_section">
      ...
      <div class="relate_functions">
        <filter-report v-if="displaySortReport" class="filter_report" :select-category="selectedCategory"
                       @listcheckbox="handleListCheckbox" @categoryselect="handleCategorySelect"/>
