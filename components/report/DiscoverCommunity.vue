...
import allReports from '~/public/file_json/list_category_shopee.json';
import ItemDiscoverCommunity from "~/components/report/ItemDiscoverCommunity.vue";
...
<template>
  <div class="discover default_section">
    <div class="title">Phân tích dữ liệu theo ngành hàng</div>
    <item-discover-community :show-more="showMore" :reports="reports" class="lst_item"/>
    <div class="see_more">
