  ...
  <div class="general_overview">
    ...
    <InsightBlock v-else>
      ...
      <li>
        ...
        {{ diffRevenueMonths?.diffPercent !== undefined && diffRevenueMonths.diffPercent > 0 ? "tốt" : "thấp" }} hơn so với tháng        đạt
        <BlurContent :is-hide-content="isHideContent">
    <span>
      {{
        ...
        {{ diffRevenueMonths?.diffPercent !== undefined && diffRevenueMonths.diffPercent > 0 ? "tốt" : "thấp" }} hơn so với
        tháng
