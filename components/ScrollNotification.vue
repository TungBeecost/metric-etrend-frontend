  ...
  <div v-if="showNotification && !isMobile" class="custom-notification">
    <div class="notification-content">
      ...
      <div class="notification-body">
        <div style="text-align: center; width: 100%;" class="py-3">
          <p style="font-size: 24px; font-weight: 700; line-height: 28px;">Bạn cần dữ liệu báo cáo này?</p>
        </div>
        <div style="display: flex; justify-content: center; width: 100%; margin-bottom: 12px;">
          <p style="color: #241E46; font-weight: 400; text-align: center; width: 100%;" class="py-3">
            <span style="color:#716B95; line-height: 22px;">Lấy tất cả số liệu từ phần mềm phân tích Metric</span>
          </p>
        </div>
        <AButton
    ...
    <img loading="lazy" src="/images/ImageOnBackgroundScroll.png" alt="ImageOnBackgroundScroll"
