...
const handleItemClick = (report: any) => {
  router.push(`${NAVIGATIONS.home}${report.slug}`);
};
        ...
        <div class="slide-item" @click="handleItemClick(report)">
          ...
          <div class="content" style="text-align: left;">
            <div class="category_date" style="text-align: left; display: flex; align-items: center; gap: 4px">
              Báo cáo khác <span style="color: #EEEBFF">|</span>
              {{ dayjs(report.start_date).format('DD/MM/YYYY') }} <span style="color: #EEEBFF">|</span>
            ...
            <div class="title" :class="{ 'line-clamp__2': windowWidth < 768 }" style="text-align: left;">
