...
const reportTitle = computed(() => {
  return `Báo cáo phân tích giá ${props.data?.reportDetail?.name || ''} - Nghiên cứu thị trường TMĐT`;
});
</script>

<!-- <style scoped>
.prices-report-template {
  width: 100%;
}
