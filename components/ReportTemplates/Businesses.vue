<template>
    ...
    <div class="container_report_detail">
      <div class="container_report_detail_left">
        <p>Businesses template content</p>
...
const reportTitle = computed(() => {
  return `Báo cáo phân tích doanh nghiệp ${props.data?.reportDetail?.name || ''} - Nghiên cứu thị trường TMĐT`;
});
</script>

<!-- <style scoped>
.businesses-report-template {
  width: 100%;
}
...
.business-overview, .business-analysis {
  margin-bottom: 32px;
}
</style> -->