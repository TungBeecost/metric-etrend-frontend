  ...
  <div id="chi-tiet-shop">
    <div class="main-slide">
      <div class="title">
        ...
        <img v-if="shopDetail.official_type === 0" :src="platformIcons[shopDetail.platform_id].normal"
             class="platform-icon" style="border-radius: 50%"/>
        <img v-else :src="platformIcons[shopDetail.platform_id]?.mall" class="platform-icon"
